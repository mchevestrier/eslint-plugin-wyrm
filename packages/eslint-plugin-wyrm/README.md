...
| [no-useless-logical-fallback](https://github.com/mchevestrier/eslint-plugin-wyrm/blob/master/packages/eslint-plugin-wyrm/docs/rules/no-useless-logical-fallback.md)         | Forbid useless default values for nullish coalescing expressions          | ✅ ☑️       |     | 💡  | 💭  |
